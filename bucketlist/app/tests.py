...
class BucketlistTest(TestCase):
    ...
    def test_3_page_authorization(self):
        ...
        response = self.client.get("/bucketlists/", format='json')
    ...
    def test_5_bucketlist(self):
    	...
    	response = self.client.post("/bucketlists/", data,format='json')
    ...
    def test_6_add_edit_item(self):
    	...
    	url = "/bucketlists/{}/items/".format(bid)
